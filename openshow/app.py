...
from .terminal import copy_to_clipboard, init_terminal, key_code, prompt, safe_addstr, set_cursor
from .text import display_width, offset_links, parent_path, slugify_heading, strip_inline_markup, truncate_to_display_width, visual_ljust, visual_x_to_char_index
from .themes import THEME_ORDER, THEMES
...
class App:
    ...
    def start_edit(self) -> None:
        ...
        if not self.current.editable:
            self.status = f"{self.current.rel} is view-only in OpenShow"
            return
        self.mode = "edit"
